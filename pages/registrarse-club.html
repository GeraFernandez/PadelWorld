    ...
    <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
      <div class="row gx-lg-5 align-items-center mb-5">
        <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
          <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(3, 94%, 47%)">
            CLUBES <br />
            <span style="color: hsl(234, 79%, 65%)">PADEL WORLD</span>
          </h1>
          <p class="mb-4 opacity-70 texto-login">
            Gestiona tu club. Reservas, precios, torneos y mucho mas
          </p>
        </div>
            ...
            <div class="card-body px-4 py-5 px-md-5">
              <form action="<?php echo $_SERVER['PHP_SELF']; ?>" name="padelworld" method="post">
                ...
                <div class="form-outline mb-3">
                  <label class="form-label" for="form3Example3">RAZON SOCIAL</label>
